		...
		<div class="row">
		  <div class="col-10">
		    <div class="list-group" id="list-tab" role="tablist">
		      ...
		      <a class="list-group-item list-group-item-action active" id="list-profile-list" href="/contact/send" role="tab">송신함</a>
			...
			<tbody>
				<c:forEach items="${list}" var="item">
					<tr>
						...
						<td><a href="/contact/send/detail/${item.idx}">${item.title}</a></td>
